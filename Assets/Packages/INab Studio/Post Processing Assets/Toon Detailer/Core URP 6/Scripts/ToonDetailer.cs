...
namespace INab.ToonDetailer.URP
{
    ...
    public class ToonDetailer : ScriptableRendererFeature
    {
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            if (m_ToonDetailerMaterial == null) m_ToonDetailerMaterial = CoreUtils.CreateEngineMaterial(Shader.Find("Hidden/INabStudio/ToonDetailer"));
            if (m_DepthMaterial == null) m_DepthMaterial = CoreUtils.CreateEngineMaterial(Shader.Find("Hidden/INabStudio/ToonDetailer/DepthMask"));
